namespace LeagueSharp.Common
{
    ...
    public class CPSlider
    {
        ...
        public CPSlider(int x, int y, int height, float percent = 1)
        {
            this.xPos = x;
            this.yPos = y;
            this.Height = height - Resources.SliderActive.Height;
            this.percent = percent;

            this.ActiveSprite = new Render.Sprite(Resources.SliderActive, new Vector2(this.X, this.Y));
            this.InactiveSprite = new Render.Sprite(Resources.SliderDisabled, new Vector2(this.X, this.Y));
        ...
        public int Width
        {
            get
            {
                return Resources.SliderActive.Width;
            }
        }
        ...
        {
            this.Percent = (Utils.GetCursorPos().Y - (Resources.SliderActive.Height / 2f) - this.Y) / this.Height;
