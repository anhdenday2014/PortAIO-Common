...
namespace LeagueSharp.Common
{
    ...
    public static class Utility
    {
        ...
        public static bool LSIsFacing(this Obj_AI_Base source, Obj_AI_Base target)
        {
            ...
            return source.Direction.LSTo2D().LSPerpendicular().LSAngleBetween((target.Position - source.Position).LSTo2D()) < angle;
        }
        ...
        /// </summary>
        public static bool LSIsBothFacing(Obj_AI_Base source, Obj_AI_Base target)
        {
        ...
        /// </summary>
        public static bool LSIsValidTarget(this AttackableUnit unit, float? range = float.MaxValue, bool checkTeam = true, Vector3 from = new Vector3())
        {
        ...
        /*    if (checkTeam && unit.Team == HeroManager.Player.Team)
            ...
            if (checkTeam && Player.Instance.Team == unit.Team)
            {
                return false;
            }
            ...
            return !(range < float.MaxValue) ||
                   !(Vector2.DistanceSquared(
                       (@from.LSTo2D().LSIsValid() ? @from : HeroManager.Player.ServerPosition).LSTo2D(),
                       (@base != null ? @base.ServerPosition : unit.Position).LSTo2D()) > range * range);
        }
        ...
        /// </summary>
        public static bool LSIsReady(this SpellDataInst spell, int t = 0)
        {
        ...
        ///     Returns if the spell is ready to use.
        /// </summary>
        public static bool LSIsReady(this Spell spell, int t = 0)
        {
            return LSIsReady(spell.Instance, t);
        }

        /// <summary>
        ///     Returns if the spell is ready to use.
        /// </summary>
        public static bool LSIsReady(this SpellSlot slot, int t = 0)
        {
            var s = HeroManager.Player.Spellbook.GetSpell(slot);
            return s != null && LSIsReady(s, t);
        }
        ...
        /// </summary>
        public static bool LSIsAutoAttack(this SpellData spellData)
        {
        ...
        ///     Checks if this spell is an autoattack
        /// </summary>
        public static bool LSIsAutoAttack(this SpellDataInst spellData)
        {
            return Orbwalking.IsAutoAttack(spellData.Name);
        }
        ...
        /// </summary>
        public static bool LSIsCasted(this Spell.CastStates state)
        {
        ...
        /// </summary>
        public static List<Vector2> LSGetWaypoints(this Obj_AI_Base unit)
        {
            var result = new List<Vector2>();
        ...
        public static List<Vector2Time> LSGetWaypointsWithTime(this Obj_AI_Base unit)
        {
            var wp = unit.LSGetWaypoints();
        ...
        /// </summary>
        public static bool LSIsValidBuff(this BuffInstance buff)
        {
        ...
        /// </summary>
        public static bool LSHasBuffIn(this Obj_AI_Base unit, string displayName, float tickCount, bool includePing = true)
        { 
            return
                unit.Buffs.Any(
                    buff =>
        ...
        /// </summary>
        public static bool LSUnderTurret(this Obj_AI_Base unit)
        {
            return LSUnderTurret(unit.Position, true);
        }

        /// <summary>
        ///     Returns true if the unit is under turret range.
        /// </summary>
        public static bool LSUnderTurret(this Obj_AI_Base unit, bool enemyTurretsOnly)
        {
            return LSUnderTurret(unit.Position, enemyTurretsOnly);
        }

        public static bool LSUnderTurret(this Vector3 position, bool enemyTurretsOnly)
        {
            return
        ...
        /// <returns></returns>
        public static bool LSUnderAllyTurret(this Obj_AI_Base unit)
        {
            return LSUnderAllyTurret(unit.Position);
        }
        public static bool LSUnderAllyTurret(this Vector3 position)
        {
            return
                ObjectManager.Get<Obj_AI_Turret>().Any(turret => turret.LSIsValidTarget(950, false, position) && turret.IsAlly);
        }
  ...
  //      [Obsolete("Use CountEnemiesInRange", false)]
   ...
   //     [Obsolete("Use CountEnemiesInRange", false)]
        ...
        /// </summary>
        public static int LSCountAlliesInRange(float range)
        {
            return HeroManager.Player.LSCountAlliesInRange(range);
        }

        /// <summary>
        ///     Counts the allies in range of the Unit.
        /// </summary>
        public static int LSCountAlliesInRange(this Obj_AI_Base unit, float range)
        {
            return unit.ServerPosition.LSCountAlliesInRange(range, unit);
        }

        /// <summary>
        ///     Counts the allies in the range of the Point. 
        /// </summary>
        public static int LSCountAlliesInRange(this Vector3 point, float range, Obj_AI_Base originalunit = null)
        {
        ...
        public static List<AIHeroClient> LSGetAlliesInRange(this Obj_AI_Base unit, float range)
        {
            return LSGetAlliesInRange(unit.ServerPosition, range, unit);
        }

        public static List<AIHeroClient> LSGetAlliesInRange(this Vector3 point, float range, Obj_AI_Base originalunit = null)
        {
            if (originalunit != null)
            {
                return
                    HeroManager.Allies
                        .FindAll(x => x.NetworkId != originalunit.NetworkId && point.LSDistance(x.ServerPosition, true) <= range*range);
            }
            return
                   HeroManager.Allies
        ...
        public static List<AIHeroClient> LSGetEnemiesInRange(this Obj_AI_Base unit, float range)
        {
            return LSGetEnemiesInRange(unit.ServerPosition, range);
        }

        public static List<AIHeroClient> LSGetEnemiesInRange(this Vector3 point, float range)
        {
            return
                HeroManager.Enemies
                    .FindAll(x => point.LSDistance(x.ServerPosition, true) <= range * range);
...
//        [Obsolete("Use Render.Circle", false)]
        ...
        /// </summary>
        /// <returns></returns>
        public static bool LSInShop(this Obj_AI_Base unit)
        {
        ...
        /// </summary>
        public static bool LSInFountain(this Obj_AI_Base unit, FountainType ftype = FountainType.OwnFountain)
        {
            float fountainRange = 562500; //750 * 750
            var map = Map.GetMap();
            if (map != null && map.Type == Map.MapType.SummonersRift)
        ...
        /// </summary>
        public static bool LSInFountain(this Vector3 position, FountainType fountain)
        {
            return position.LSTo2D().LSInFountain(fountain);
        }

        /// <summary>
        ///     Checks a point to see if it is in an ally or enemy fountain
        /// </summary>
        public static bool LSInFountain(this Vector2 position, FountainType fountain)
        {
            float fountainRange = 562500; //750 * 750
            var map = Map.GetMap();
            if (map != null && map.Type == Map.MapType.SummonersRift)
        ...
        public static short LSGetPacketId(this GamePacketEventArgs gamePacketEventArgs)
        {
        ...
        public static void LSSendAsPacket(this byte[] packetData,
