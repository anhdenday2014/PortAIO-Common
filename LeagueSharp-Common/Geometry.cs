...
namespace LeagueSharp.Common
{
    ...
    public static class Geometry
    {
        ...
        /// <returns></returns>
        public static bool LSIsValid(this Vector2 v)
        {
        ...
        /// <param name="v">The vector.</param>
        /// <returns></returns>
        public static bool LSIsValid(this Vector3 v)
        {
        ...
        /// <param name="v">The vector.</param>
        /// <returns></returns>
        public static Vector2 LSPerpendicular2(this Vector2 v)
        {
            return new Vector2(v.Y, -v.X);
        }
        ...
        /// <param name="angle">The angle.</param>
        /// <returns></returns>
        public static float LSRadianToDegree(double angle)
        {
        ...
        public static float LSPolar(this Vector2 v1)
        {
            ...
            var theta = LSRadianToDegree(Math.Atan((v1.Y) / v1.X));
            if (v1.X < 0)
            {
                theta = theta + 180;
            }
