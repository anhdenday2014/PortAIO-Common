...
*/
	    ...
	    */
                        ...
                        new DamageSpell
                            {
                                ...
                                Damage =
                                    (source, target, level) =>
                                    (48 + 4 * ((AIHeroClient)source).Level) + 0.1 * source.TotalMagicalDamage
                        ...
                        new DamageSpell
                            {
                                ...
                                Damage =
                                    ...
                                    + 0.45 * source.TotalMagicalDamage
                                    + 0.03 * (source.MaxMana - 392.4 - 52 * (source as AIHeroClient).Level ) ) * (1 + (target.HasBuff("RyzeE") ? new double[] { 40, 55, 70, 85, 100 }[ObjectManager.Player.Spellbook.GetSpell(SpellSlot.E).Level - 1] / 100 : 0))
                            },
                        //W
                        new DamageSpell
                            {
                                ...
                                Damage =
                                    ...
                                    + 0.2 * source.TotalMagicalDamage + 0.01 * (source.MaxMana - 392.4 - 52 * (source as AIHeroClient).Level)
                            },
                        //E
                        new DamageSpell
                            {
                                ...
                                Damage =
                                    (source, target, level) =>
                                    new double[] { 50, 75, 100, 125, 150 }[level]
                                    + 0.3 * source.TotalMagicalDamage + 0.02 * (source.MaxMana - 392.4 - 52 * (source as AIHeroClient).Level)
                            },
                    });
        ...
        /// <returns></returns>
        public static DamageSpell LSGetDamageSpell(this Obj_AI_Base source, Obj_AI_Base target, string spellName)
        {
            ...
            if (hero != null)
            {
                return (from spell in hero.Spellbook.Spells
                        ...
                        select LSGetDamageSpell(hero, target, spell.Slot)).FirstOrDefault();
            }
        ...
        /// <returns></returns>
        public static DamageSpell LSGetDamageSpell(
            this AIHeroClient source,
            Obj_AI_Base target,
            SpellSlot slot,
            int stage = 0)
        ...
        {
            var spell = LSGetDamageSpell(source, target, spellName);
        ...
        {
            var spell = LSGetDamageSpell(source, target, slot, stage);
            return spell != null ? spell.CalculatedDamage : 0d;
        }
