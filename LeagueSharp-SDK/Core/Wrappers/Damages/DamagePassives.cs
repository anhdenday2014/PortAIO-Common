                ...
                switch (name)
                {
                    ...
                    case "Braum":
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) => 16 + 10 * ((AIHeroClient)@base.GetBuff("braummark").Caster).Level);
                        AddPassiveAttack(
                            "Braum",
                    ...
                    case "Darius":
                        AddPassiveAttack(
                            "Darius",
                            (hero, @base) => @base is AIHeroClient,
                            DamageType.Physical,
                            (hero, @base) =>
                    ...
                    case "Fizz":
                        AddPassiveAttack(
                            "Fizz",
                            (hero, @base) => hero.Spellbook.GetSpell(SpellSlot.W).Level > 0 && @base is AIHeroClient,
                            DamageType.Magical,
                    ...
                    case "Gangplank":
                        AddPassiveAttack(
                            "Gangplank",
                            (hero, @base) => hero.HasBuff("gangplankpassiveattack") && @base is AIHeroClient,
                            DamageType.True,
                    ...
                    case "Kalista":
                        ...
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) =>
                            ((AIHeroClient)@base.GetBuff("kalistacoopstrikemarkbuff").Caster).GetSpellDamage(
                                @base,
                                SpellSlot.W),
                            true);
                        break;
                    ...
                    case "Nautilus":
                        ...
                        AddPassiveAttack(
                            "Nautilus",
                            (hero, @base) => hero.HasBuff("nautiluspiercinggazeshield") && @base is AIHeroClient,
                            DamageType.Magical,
                            (hero, @base) => hero.GetSpellDamage(@base, SpellSlot.W),
                            true);
                        break;
