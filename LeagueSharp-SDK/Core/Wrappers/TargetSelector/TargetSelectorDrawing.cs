...
namespace LeagueSharp.SDK
{
    ...
    internal class TargetSelectorDrawing
    {
        ...
        /// </summary>
        private AIHeroClient weightBestTarget;
        ...
        ///     The weight targets
        /// </summary>
        private List<Tuple<AIHeroClient, float>> weightTargets = new List<Tuple<AIHeroClient, float>>();
        ...
        private void OnGameUpdate(EventArgs args)
        {
            ...
            this.weightTargets = (from enemy in enemies
                                  ...
                                  select new Tuple<AIHeroClient, float>(enemy, sw)).OrderByDescending(w => w.Item2)
                .ToList();
