...
namespace LeagueSharp.SDK
{
    ...
    public class TargetSelectorLockTarget
    {
        ...
        /// </summary>
        private AIHeroClient lockedTarget;
        ...
        /// </summary>
        public AIHeroClient LockedTarget
        {
            get
            {
        ...
        /// </param>
        public void LockTarget(AIHeroClient target)
        {
        ...
        /// </param>
        private void LockTarget(AIHeroClient target, bool notify)
        {
            if (!this.Enabled)
            {
                return;
