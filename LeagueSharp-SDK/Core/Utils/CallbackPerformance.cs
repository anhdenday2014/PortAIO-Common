    ...
    public class CallbackPerformance
    {
            ...
            [CallerMemberName] string memberName = "")
        {
            try
            {
                ...
                //LogManager.GetCurrentClassLogger().Info($"{memberName} has taken {stopwatch.ElapsedMilliseconds} elapsed milliseconds to execute, and was executed successfuly.");
            ...
            [CallerMemberName] string memberName = "")
        {
            try
            {
                ...
                //LogManager.GetCurrentClassLogger().Info($"{memberName} has taken {stopwatch.ElapsedTicks} elapsed ticks to execute, and was executed successfuly.");
